...
export default {
  data() {
    return {
      ...
      richMenuName: '',
      normalMode: emptySelectValue,
      bosaiMode: emptySelectValue,
  ...
  methods: {
    clearSearchCriteria: function () {
      this.richMenuName = '';
      this.normalMode = emptySelectValue;
      this.bosaiMode = emptySelectValue;
      this.onClickSearch();
    },
    onClickSearch: function () {
      this.searchCriteria = {
        richMenuName: this.richMenuName,
        normalMode: this.normalMode,
        bosaiMode: this.bosaiMode,
      }
